...
<execution_context>
@/home/user/makeitmemeTamir/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/makeitmemeTamir/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
