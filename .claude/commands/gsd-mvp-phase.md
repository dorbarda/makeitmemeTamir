...
<execution_context>
@/home/user/makeitmemeTamir/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/makeitmemeTamir/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
