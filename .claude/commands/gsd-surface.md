...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/makeitmemeTamir/.claude/.gsd-surface.json`
(sibling to `/home/user/makeitmemeTamir/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/makeitmemeTamir/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/makeitmemeTamir/.claude/skills`).
...
`/home/user/makeitmemeTamir/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/makeitmemeTamir/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/makeitmemeTamir/.claude/.gsd-surface.json`
Install profile marker: `/home/user/makeitmemeTamir/.claude/.gsd-profile`
Skill dirs: `/home/user/makeitmemeTamir/.claude/skills/gsd-*/`
Engine module: `/home/user/makeitmemeTamir/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/makeitmemeTamir/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
