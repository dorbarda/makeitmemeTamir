...
Use template from `/home/user/makeitmemeTamir/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/makeitmemeTamir/.claude/gsd-core/templates/UI-SPEC.md`
