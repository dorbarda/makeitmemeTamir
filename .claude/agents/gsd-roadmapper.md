...
Reference full template: `/home/user/makeitmemeTamir/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/makeitmemeTamir/.claude/gsd-core/templates/state.md`.
