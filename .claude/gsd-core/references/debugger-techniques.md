...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/makeitmemeTamir/.claude
                  → checks /home/user/makeitmemeTamir/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/makeitmemeTamir/.claude/gsd-core
                  → writes to /home/user/makeitmemeTamir/.claude/gsd-core/hooks/
