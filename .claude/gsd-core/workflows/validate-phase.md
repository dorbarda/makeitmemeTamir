...
```
Agent(
  prompt="Read /home/user/makeitmemeTamir/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/makeitmemeTamir/.claude/gsd-core/templates/VALIDATION.md`
