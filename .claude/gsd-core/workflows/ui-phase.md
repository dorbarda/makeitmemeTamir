...
```markdown
Read /home/user/makeitmemeTamir/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/makeitmemeTamir/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/makeitmemeTamir/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/user/makeitmemeTamir/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/user/makeitmemeTamir/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/user/makeitmemeTamir/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/user/makeitmemeTamir/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
