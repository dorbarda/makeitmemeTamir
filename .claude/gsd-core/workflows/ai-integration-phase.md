...
<required_reading>
@/home/user/makeitmemeTamir/.claude/gsd-core/references/ai-frameworks.md
@/home/user/makeitmemeTamir/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/user/makeitmemeTamir/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/user/makeitmemeTamir/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/user/makeitmemeTamir/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/user/makeitmemeTamir/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/user/makeitmemeTamir/.claude/agents/gsd-eval-planner.md for instructions.
